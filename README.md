...
- [Consigna](#Consigna)
    - [Implementación](#Implementación)
        ...
        - [Canciones más importantes](#Cancionesmásimportantes)
        - [Recomendación (usuarios o canciones)](#Recomendación-(usuarios-o-canciones))
        - [Ciclo de n canciones](#Ciclo-de-n-canciones)
        - [Todas en Rango](#Todas-en-Rango)
        - [Coeficiente de Clustering](#Coeficiente-de-Clustering)
- [Entrega](#Entrega)
...
Como dicho archivo contiene una enorme cantidad de entradas, les dejamos también [un archivo más reducido](https://drive.google.com/file/d/1zW7y0XwlXFGOxjA0tgRJRrd4vZHrxzhO/view), para que puedan realizar pruebas más rápidamente.
